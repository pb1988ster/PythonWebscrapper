...
def get_agents(zip_code):
    ...
    z = zip_code
    details = []
    print 'getting Properties for ' + str(z)
    start = time.time()
#     page = 'http://www.weichert.com/' +sys.argv[1]+'/'+ str(z)+'/?type=wei'
#     page = 'http://www.weichert.com/' +sys.argv[1]+'/'+ str(z)
    page = 'http://www.weichert.com/CA/'+ str(z)
    print page
    ...
    for link in soup.findAll('a'):
        try:
            if 'profile/' in link['href'] and '/Reviews' not in link['href']:
                profiles.append('http://www.weichert.com/CA/' + str(link['href']))
        except: pass
